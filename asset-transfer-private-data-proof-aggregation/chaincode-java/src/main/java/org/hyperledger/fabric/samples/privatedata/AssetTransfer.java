 ...
 *
 * To create fabric modified-test-net
 *   cd fabric-samples/modified-test-net
 *   ./network.sh up createChannel -ca -s couchdb
 * To deploy this chaincode to modified-test-net, use the collection config as described in
 ...
 *  ./network.sh deployCC -ccn private -ccp ../asset-transfer-private-data-proof-aggregation/chaincode-java/ -ccl java -ccep "OR('Org1MSP.peer','Org2MSP.peer')" -cccg ../asset-transfer-private-data-proof-aggregation/chaincode-go/collections_config.json -ccs 1 -ccv 1
 */
@Contract(
        name = "private",
        info = @Info(
