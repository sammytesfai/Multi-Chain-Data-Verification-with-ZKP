...
ORDERER_CA=${DIR}/modified-test-net/organizations/ordererOrganizations/example.com/tlsca/tlsca.example.com-cert.pem
...
if [[ ${ORG,,} == "org1" || ${ORG,,} == "digibank" ]]; then
   ...
   CORE_PEER_MSPCONFIGPATH=${DIR}/modified-test-net/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
   CORE_PEER_ADDRESS=localhost:7051
   CORE_PEER_TLS_ROOTCERT_FILE=${DIR}/modified-test-net/organizations/peerOrganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem

elif [[ ${ORG,,} == "org2" || ${ORG,,} == "magnetocorp" ]]; then

   CORE_PEER_LOCALMSPID=Org2MSP
   CORE_PEER_MSPCONFIGPATH=${DIR}/modified-test-net/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
